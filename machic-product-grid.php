<?php
// D:\wamp64\www\turbo\wp-content\plugins\machic-core\elementor\widgets\machic-product-grid.php
...
class Machic_Product_Grid_Widget extends Widget_Base
{
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			'countdown_opacity_important_style',
			[
				'label' => esc_html__('Opacity', 'machic-core'),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
