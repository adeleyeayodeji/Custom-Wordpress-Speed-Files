<?php
//path D:\wamp64\www\turbo\wp-content\plugins\machic-core\elementor\widgets\machic-product-list.php
// update 'posts_per_page' => 10, //$settings['post_count'],
namespace Elementor;
...
class Machic_Product_List_Widget extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'product_title_opacity_important_style',
            [
                'label' => esc_html__('Opacity', 'machic-core'),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
        ...
        $this->add_control(
            'regular_price_opacity_important_style',
            [
                'label' => esc_html__('Opacity', 'machic-core'),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
        ...
        $this->add_control(
            'sale_price_opacity_important_style',
            [
                'label' => esc_html__('Opacity', 'machic-core'),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
    ...
    protected function render()
    {
        ...
        $args = array(
            'post_type' => 'product',
            'posts_per_page' => 10, //$settings['post_count'],
            'order'          => 'DESC',
            'post_status'    => 'publish',
            'paged'             => $paged,
